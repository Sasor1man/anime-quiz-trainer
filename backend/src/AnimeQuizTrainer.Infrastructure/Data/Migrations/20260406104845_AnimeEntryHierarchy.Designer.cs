...
namespace AnimeQuizTrainer.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260406104845_AnimeEntryHierarchy")]
    partial class AnimeEntryHierarchy
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AnimeQuizTrainer.Domain.Entities.Series", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AnimeQuizTrainer.Domain.Entities.Anime", b =>
                {
                    ...
                    b.HasOne("AnimeQuizTrainer.Domain.Entities.Series", null)
                        .WithMany("Animes")
